...
class Connector implements ConnectorInterface
{
     ...
     */
    public function __construct($client, $email, $password, $answer, $backupcode, $platform, $endpoint, $payload = null)
    {
        $this->client = $client;
        $this->email = $email;
        ...
        if (in_array($this->endpoint, $this->endpoints, true)) {
            ...
            switch($this->endpoint) {
                case Forge::ENDPOINT_WEBAPP:
                    $this->connector = new WebApp($this->email, $this->password, $this->answer, $backupcode, $this->platform);
                    break;
            ...
            $this->connector->connect($backupcode);
        }
